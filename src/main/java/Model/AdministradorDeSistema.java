...
<<<<<<< HEAD
    ...
    public AdministradorDeSistema(List<Usuario> usuario, Sector sector, Usuario usu, long id, String nombre, String apellido, String fechaDeNac, String domicilio, int dni, String telefonoFijo, String telefonoCel, String correoE, String estadoCivil) {
